...
def main(argv: list[str] | None = None) -> int:
    ...
    for plan_file in plan_files:
        ...
        offering_result_raw = run_cmd(
            [
                sys.executable,
                str(script_dir / "offering_checker.py"),
                str(plan_file),
                "--offerings",
                str(offerings_file),
                "--result-json",
